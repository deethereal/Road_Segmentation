...
######
u7_0=tf.keras.layers.Conv2DTranspose(512,(2,2),strides=(2,2),padding='same')(c7_1024)
...
results=model.fit(X_TRAIN,Y_TRAIN,validation_split=0.1, batch_size=11,epochs=50, callbacks=callbacks)
